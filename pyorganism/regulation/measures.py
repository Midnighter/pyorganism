...
def continuous_functional_coherence(network, elem2level, function="function"):
    control = 0.0
    total = 0.0
...
def multi_continuous_functional_coherence(network, elem2level):
    control = 0.0
    total = 0.0
...
def continuous_functional_comparison(network, elem2level, function="function"):
    control = 0.0
    total = 0.0
    for (u, v, data) in network.edges_iter(data=True):
        func = data[function]
...
def multi_continuous_functional_comparison(network, elem2level):
    control = 0.0
    total = 0.0
    for (u, v, k) in network.edges_iter(keys=True):
        if k == 1:
...
def multi_delayed_continuous_functional_coherence(network, elem2level, elem2delayed):
    control = 0.0
    total = 0.0
    for (u, v, k) in network.edges_iter(keys=True):
        if k == 1:
