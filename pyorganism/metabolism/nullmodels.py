...
__all__ = ["make_consistent_stoichiometry"]
...
def make_consistent_stoichiometry(network, coefficients, mass_vector=None):
    ...
    def balance_reaction_by_mass(reaction):
        ...
        try:
            ...
            raise PyOrganismError("Reaction '{0}' cannot be balanced with the"\
    ...
    # coefficients
    model.make_integer(network.compounds)
