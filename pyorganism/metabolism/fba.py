...
class FBAModel(object):
    ...
    def make_binary(self, reaction):
        """
        Make a reaction variable in the model binary.

        The method can also be used for multiple reactions at the same time.
        In that case the argument must be an iterable.
    ...
    def make_integer(self, reaction):
        """
        Make a reaction variable in the model integer-only.
